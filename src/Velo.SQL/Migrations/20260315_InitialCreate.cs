...
namespace Velo.SQL.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PipelineName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    RunNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PipelineRuns_org_project_starttime",
                table: "PipelineRuns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoraMetrics_org_project_computedat",
                table: "DoraMetrics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamHealth_org_project_computedat",
                table: "TeamHealth",
                columns: new[] { "OrgId", "ProjectId", "ComputedAt" });
        }
        ...
        {
            migrationBuilder.DropTable(name: "TeamHealth");
            migrationBuilder.DropTable(name: "DoraMetrics");
