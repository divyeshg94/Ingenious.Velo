...
namespace Velo.SQL.Migrations
{
    ...
    [Migration("20260921000000_AddGrowthFeatures")]
    partial class AddGrowthFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Velo.SQL.Models.DoraMetrics", b =>
                {
                    ...
                    b.Property<bool>("IsChangeFailureRateEstimated")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsDeploymentFrequencyEstimated")
                        .HasColumnType("bit");

                    b.Property<bool>("IsLeadTimeApproximate")
                        .HasColumnType("bit");

                    b.Property<bool>("IsMttrEstimated")
                        .HasColumnType("bit");

                    b.Property<bool>("IsReworkRateEstimated")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("OrgId", "ProjectId", "ComputedDate", "RepositoryName")
                        .IsUnique()
                        .HasDatabaseName("UX_DoraMetrics_OrgId_ProjectId_ComputedDate_RepositoryName");

                    b.HasIndex("OrgId", "ProjectId", "RepositoryName", "ComputedAt")
            ...
            modelBuilder.Entity("Velo.SQL.Models.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrgId", "CreatedDate")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_Feedback_OrgId_CreatedDate_DESC");

                    b.HasIndex("OrgId", "FeedbackType")
            ...
            modelBuilder.Entity("Velo.SQL.Models.OrgContext", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FirstDoraViewedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("FirstShareCreatedAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset?>("ReEngagementEmailSentAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("AadTenantId")
                        .HasDatabaseName("IX_Organizations_AadTenantId");

                    b.ToTable("Organizations");
                });

            modelBuilder.Entity("Velo.SQL.Models.SharedReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("OrgDisplayName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Velo.SQL.Models.OrganizationSettings", b =>
                {
                    b.Property<string>("OrgId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Velo.SQL.Models.PullRequestEvent", b =>
                {
                    ...
                    b.Property<int?>("CycleDurationMinutes")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReviewerNames")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("Velo.SQL.Models.WorkItemEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrgId", "WorkItemId")
                        .HasDatabaseName("IX_WorkItemEvents_OrgId_WorkItemId");

                    b.HasIndex("OrgId", "ProjectId", "ChangedAt")
                        .IsDescending(false, false, true)
